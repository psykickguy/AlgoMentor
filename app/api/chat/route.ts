  ...
  try {
    ...
    const chatSession = model.startChat({
      ...
      history: [
        ...
        {
          role: "user",
          parts: [{ text: "What are you supposed to do?\n" }],
        },
        {
          role: "model",
          parts: [
        ...
        {
          role: "user",
          parts: [{ text: "who are you supposed to be ?\n" }],
        },
        {
          role: "model",
          parts: [
        ...
        {
          role: "user",
          parts: [{ text: "where can i access this project" }],
        },
        {
          role: "model",
          parts: [
    ...
    if (!result || !result.response || !result.response.text) {
      throw new Error(
        "Invalid response structure from the Generative AI model",
      );
    }
